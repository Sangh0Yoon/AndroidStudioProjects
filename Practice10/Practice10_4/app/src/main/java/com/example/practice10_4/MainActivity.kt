package com.example.practice10_4

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.system.Os
import android.widget.Toast
import com.example.practice10_4.databinding.ActivityMainBinding
                ...
                timer(period = 1500, initialDelay = 1000)
                {
                    ...
                    db.collection("player").document("test@gmail.com").set(axloc)
                        .addOnSuccessListener {
                            Toast.makeText(this@MainActivity,"set success",Toast.LENGTH_LONG).show()
                        }
                        .addOnFailureListener {
                            Toast.makeText(this@MainActivity,"set failed",Toast.LENGTH_LONG).show()
                        }
                }
            }
        })
